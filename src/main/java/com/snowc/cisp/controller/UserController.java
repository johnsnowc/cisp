package com.snowc.cisp.controller;
...
import com.snowc.cisp.utils.FileUtil;
import com.snowc.cisp.utils.ReturnJson;
  ...
  public ReturnJson doRegister(@RequestBody User user) {
    try {
      ...
      if ("男".equals(user.getGender())) {
        user.setAvatar("http://qpzry9s81.hn-bkt.clouddn.com/0.jpg");
      }
      if ("女".equals(user.getGender())) {
        user.setAvatar("http://qpzry9s81.hn-bkt.clouddn.com/3.jpg");
      }
